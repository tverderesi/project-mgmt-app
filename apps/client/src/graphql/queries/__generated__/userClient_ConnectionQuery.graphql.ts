...
export type userClient_ConnectionQuery$variables = {
...
export type userClient_ConnectionQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"userClient_Connection">;
  } | null | undefined;
};
export type userClient_ConnectionQuery = {
  response: userClient_ConnectionQuery$data;
  variables: userClient_ConnectionQuery$variables;
};
