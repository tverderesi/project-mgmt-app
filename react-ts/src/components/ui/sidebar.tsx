...
export const Sidebar: React.FC<SidebarProps> = ({ children, className }) => {
  ...
  return (
    <aside
      ...
      className={cn(
        "-translate-x-36 md:translate-x-0 flex h-full transition-all bg-background ease-in-out duration-300 md:px-0 gap-y-2 flex-col md:w-12 pr-2 py-2 justify-start left-0 absolute md:relative z-[100] md:z-0",
